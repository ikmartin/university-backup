...
# this controls the layout of the menu bar at the top
menu_layout = [['File', ['New Ising Graph(Ctrl+N)', 'Load Ising Graph(Ctrl+O)', 'Save (Ctrl+S)', 'Save As', '--------', 'Exit']], 
               ['Tools',['No Tools Right Now']],
               ['Window',['Distance Explore']]
              ]
# this controls the main window layout
